                ...
                <div className="container">
                    <nav className="navbar navbar-expand-lg navbar-light w-100">
                        ...
                        <NavLink to="/" className="navbar-brand logo_h">
                            <img src="/resources/img/logo_divivu.jpg" width="150" height="40" alt="" />
                        </NavLink>
                                    ...
                                    <ul className="nav navbar-nav center_nav pull-right">
                                        <li className="nav-item">
                                            <NavLink exact to="/" className="nav-link"
                                                activeClassName="selected" activeStyle={{ color: '#FFBF00' }}>
                                                Trang chủ
                                            </NavLink>
                                        </li>
                                        <li className="nav-item ">
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/about" className="nav-link" activeClassName="selected" activeStyle={{ color: '#FFBF00' }}>
                                            Giới thiệu
                                            </NavLink>
                                        </li>
                                    </ul>
